...
public class Document extends org.jsoup.nodes.Element {
    ...
    private void normaliseTextNodes(org.jsoup.nodes.Element element) {
        ...
        for (int i = ((_arithmeticOperatorHotSpot16.is("PLUS") ? ((toMove.size()) + 1)) : (_arithmeticOperatorHotSpot16.is("MINUS") ? ((toMove.size()) - 1)) : (_arithmeticOperatorHotSpot16.is("MUL") ? ((toMove.size()) * 1)) : (_arithmeticOperatorHotSpot16.is("DIV") ? ((toMove.size()) / 1))) ; i >= 0 ; i--) {
...
noQuirks, quirks, limitedQuirks;    }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot16 = metamutator.Selector.of(16,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Document.class).id("_arithmeticOperatorHotSpot16");
}
