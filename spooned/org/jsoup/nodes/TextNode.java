...
public class TextNode extends org.jsoup.nodes.Node {
    ...
    public org.jsoup.nodes.TextNode splitText(int offset) {
        ...
        if ((parent()) != null)
            parent().addChildren(((_arithmeticOperatorHotSpot44.is("PLUS") ? (((siblingIndex()) + 1))) : (_arithmeticOperatorHotSpot44.is("MINUS") ? (((siblingIndex()) - 1))) : (_arithmeticOperatorHotSpot44.is("MUL") ? (((siblingIndex()) * 1))) : (_arithmeticOperatorHotSpot44.is("DIV") ? (((siblingIndex()) / 1)))), tailNode);
    ...
    static boolean lastCharIsWhitespace(java.lang.StringBuilder sb) {
        return ((sb.length()) != 0) && ((sb.charAt(((_arithmeticOperatorHotSpot42.is("PLUS") ? (((sb.length()) + 1))) : (_arithmeticOperatorHotSpot42.is("MINUS") ? (((sb.length()) - 1))) : (_arithmeticOperatorHotSpot42.is("MUL") ? (((sb.length()) * 1))) : (_arithmeticOperatorHotSpot42.is("DIV") ? (((sb.length()) / 1)))))) == ' ');
    }
    ...
    public int hashCode() {
        ...
        result = ((_arithmeticOperatorHotSpot43.is("PLUS") ? ((31 + result))) : (_arithmeticOperatorHotSpot43.is("MINUS") ? ((31 - result))) : (_arithmeticOperatorHotSpot43.is("MUL") ? ((31 * result))) : (_arithmeticOperatorHotSpot43.is("DIV") ? ((31 / result)))) + ((text) != null ? text.hashCode() : 0);
        return result;
    }

    private static final metamutator.Selector _arithmeticOperatorHotSpot42 = metamutator.Selector.of(42,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.TextNode.class).id("_arithmeticOperatorHotSpot42");

    private static final metamutator.Selector _arithmeticOperatorHotSpot43 = metamutator.Selector.of(43,new String[]{"MUL","PLUS","MINUS","DIV"}).in(org.jsoup.nodes.TextNode.class).id("_arithmeticOperatorHotSpot43");

    private static final metamutator.Selector _arithmeticOperatorHotSpot44 = metamutator.Selector.of(44,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.TextNode.class).id("_arithmeticOperatorHotSpot44");
}
