...
public abstract class Node implements java.lang.Cloneable {
    ...
    public org.jsoup.nodes.Node after(java.lang.String html) {
        addSiblingHtml(((_arithmeticOperatorHotSpot35.is("PLUS") ? (((siblingIndex) + 1))) : (_arithmeticOperatorHotSpot35.is("MINUS") ? (((siblingIndex) - 1))) : (_arithmeticOperatorHotSpot35.is("MUL") ? (((siblingIndex) * 1))) : (_arithmeticOperatorHotSpot35.is("DIV") ? (((siblingIndex) / 1)))), html);
        return this;
    }
    ...
    public org.jsoup.nodes.Node after(org.jsoup.nodes.Node node) {
        org.jsoup.helper.Validate.notNull(node);
        org.jsoup.helper.Validate.notNull(parentNode);
        parentNode.addChildren(((_arithmeticOperatorHotSpot36.is("PLUS") ? (((siblingIndex) + 1))) : (_arithmeticOperatorHotSpot36.is("MINUS") ? (((siblingIndex) - 1))) : (_arithmeticOperatorHotSpot36.is("MUL") ? (((siblingIndex) * 1))) : (_arithmeticOperatorHotSpot36.is("DIV") ? (((siblingIndex) / 1)))), node);
        return this;
    }
    ...
    protected void addChildren(org.jsoup.nodes.Node... children) {
        for (org.jsoup.nodes.Node child : children) {
            ...
            child.setSiblingIndex(((_arithmeticOperatorHotSpot40.is("PLUS") ? (((childNodes.size()) + 1))) : (_arithmeticOperatorHotSpot40.is("MINUS") ? (((childNodes.size()) - 1))) : (_arithmeticOperatorHotSpot40.is("MUL") ? (((childNodes.size()) * 1))) : (_arithmeticOperatorHotSpot40.is("DIV") ? (((childNodes.size()) / 1)))));
        }
    }

    protected void addChildren(int index, org.jsoup.nodes.Node... children) {
        org.jsoup.helper.Validate.noNullElements(children);
        for (int i = ((_arithmeticOperatorHotSpot39.is("PLUS") ? ((children.length) + 1)) : (_arithmeticOperatorHotSpot39.is("MINUS") ? ((children.length) - 1)) : (_arithmeticOperatorHotSpot39.is("MUL") ? ((children.length) * 1)) : (_arithmeticOperatorHotSpot39.is("DIV") ? ((children.length) / 1))) ; i >= 0 ; i--) {
    ...
    public java.util.List<org.jsoup.nodes.Node> siblingNodes() {
        ...
        java.util.List<org.jsoup.nodes.Node> siblings = new java.util.ArrayList<org.jsoup.nodes.Node>(((_arithmeticOperatorHotSpot34.is("PLUS") ? (((nodes.size()) + 1))) : (_arithmeticOperatorHotSpot34.is("MINUS") ? (((nodes.size()) - 1))) : (_arithmeticOperatorHotSpot34.is("MUL") ? (((nodes.size()) * 1))) : (_arithmeticOperatorHotSpot34.is("DIV") ? (((nodes.size()) / 1)))));
    ...
    public org.jsoup.nodes.Node nextSibling() {
        ...
        final int index = ((_arithmeticOperatorHotSpot37.is("PLUS") ? ((siblingIndex) + 1)) : (_arithmeticOperatorHotSpot37.is("MINUS") ? ((siblingIndex) - 1)) : (_arithmeticOperatorHotSpot37.is("MUL") ? ((siblingIndex) * 1)) : (_arithmeticOperatorHotSpot37.is("DIV") ? ((siblingIndex) / 1)));
    ...
    public org.jsoup.nodes.Node previousSibling() {
        ...
        if ((siblingIndex) > 0)
            return parentNode.childNodes.get(((_arithmeticOperatorHotSpot38.is("PLUS") ? (((siblingIndex) + 1))) : (_arithmeticOperatorHotSpot38.is("MINUS") ? (((siblingIndex) - 1))) : (_arithmeticOperatorHotSpot38.is("MUL") ? (((siblingIndex) * 1))) : (_arithmeticOperatorHotSpot38.is("DIV") ? (((siblingIndex) / 1)))));
        else
            return null;
    ...
    protected void indent(java.lang.StringBuilder accum, int depth, org.jsoup.nodes.Document.OutputSettings out) {
        accum.append("\n").append(org.jsoup.helper.StringUtil.padding(((_arithmeticOperatorHotSpot41.is("PLUS") ? ((depth + (out.indentAmount())))) : (_arithmeticOperatorHotSpot41.is("MINUS") ? ((depth - (out.indentAmount())))) : (_arithmeticOperatorHotSpot41.is("MUL") ? ((depth * (out.indentAmount())))) : (_arithmeticOperatorHotSpot41.is("DIV") ? ((depth / (out.indentAmount())))))));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        org.jsoup.nodes.Node node = ((org.jsoup.nodes.Node)(o));
    ...
    public int hashCode() {
        ...
        result = ((_arithmeticOperatorHotSpot33.is("PLUS") ? ((31 + result))) : (_arithmeticOperatorHotSpot33.is("MINUS") ? ((31 - result))) : (_arithmeticOperatorHotSpot33.is("MUL") ? ((31 * result))) : (_arithmeticOperatorHotSpot33.is("DIV") ? ((31 / result)))) + ((attributes) != null ? attributes.hashCode() : 0);
        return result;
    }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot33 = metamutator.Selector.of(33,new String[]{"MUL","PLUS","MINUS","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot33");

    private static final metamutator.Selector _arithmeticOperatorHotSpot34 = metamutator.Selector.of(34,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot34");

    private static final metamutator.Selector _arithmeticOperatorHotSpot35 = metamutator.Selector.of(35,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot35");

    private static final metamutator.Selector _arithmeticOperatorHotSpot36 = metamutator.Selector.of(36,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot36");

    private static final metamutator.Selector _arithmeticOperatorHotSpot37 = metamutator.Selector.of(37,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot37");

    private static final metamutator.Selector _arithmeticOperatorHotSpot38 = metamutator.Selector.of(38,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot38");

    private static final metamutator.Selector _arithmeticOperatorHotSpot39 = metamutator.Selector.of(39,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot39");

    private static final metamutator.Selector _arithmeticOperatorHotSpot40 = metamutator.Selector.of(40,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot40");

    private static final metamutator.Selector _arithmeticOperatorHotSpot41 = metamutator.Selector.of(41,new String[]{"MUL","PLUS","MINUS","DIV"}).in(org.jsoup.nodes.Node.class).id("_arithmeticOperatorHotSpot41");
}
