...
public abstract class Node implements java.lang.Cloneable {
    ...
    @java.lang.Override
    public int hashCode() {
        int result = (_constantOperatorMetaMutator7.is("ZERO")?( 0 ):(_constantOperatorMetaMutator7.is("INT_MAX")?( 2147483646 ):(_constantOperatorMetaMutator7.is("MIN_MIN")?( -2147483647 ):((childNodes) != null ? childNodes.hashCode() : 0))));
    ...
    private static final metamutator.Selector _constantOperatorMetaMutator7 = metamutator.Selector.of(7,new String[]{"ZERO","INT_MAX","MIN_MIN"}).in(org.jsoup.nodes.Node.class).id("_constantOperatorMetaMutator7");
}
