...
xhtml(org.jsoup.nodes.Entities.xhtmlByVal), base(org.jsoup.nodes.Entities.baseByVal), extended(org.jsoup.nodes.Entities.fullByVal);
    ...
    static java.lang.String escape(java.lang.String string, org.jsoup.nodes.Document.OutputSettings out) {
        java.lang.StringBuilder accum = new java.lang.StringBuilder(((_arithmeticOperatorHotSpot31.is("PLUS") ? (((string.length()) + 2))) : (_arithmeticOperatorHotSpot31.is("MINUS") ? (((string.length()) - 2))) : (_arithmeticOperatorHotSpot31.is("MUL") ? (((string.length()) * 2))) : (_arithmeticOperatorHotSpot31.is("DIV") ? (((string.length()) / 2)))));
...
ascii, utf, fallback;
    ...
    private static java.util.Map<java.lang.String, java.lang.Character> loadEntities(java.lang.String filename) {
        ...
        try {
            ...
            throw new java.util.MissingResourceException(((_arithmeticOperatorHotSpot32.is("PLUS") ? (("Error loading entities resource: " + (e.getMessage())))) : (_arithmeticOperatorHotSpot32.is("MINUS") ? (("Error loading entities resource: " - (e.getMessage())))) : (_arithmeticOperatorHotSpot32.is("MUL") ? (("Error loading entities resource: " * (e.getMessage())))) : (_arithmeticOperatorHotSpot32.is("DIV") ? (("Error loading entities resource: " / (e.getMessage()))))) , "Entities" , filename);
        }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot31 = metamutator.Selector.of(31,new String[]{"MUL","PLUS","MINUS","DIV"}).in(org.jsoup.nodes.Entities.class).id("_arithmeticOperatorHotSpot31");

    private static final metamutator.Selector _arithmeticOperatorHotSpot32 = metamutator.Selector.of(32,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Entities.class).id("_arithmeticOperatorHotSpot32");
}
