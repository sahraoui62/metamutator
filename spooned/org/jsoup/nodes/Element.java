...
public class Element extends org.jsoup.nodes.Node {
    ...
    public org.jsoup.nodes.Element appendChild(org.jsoup.nodes.Node child) {
        ...
        child.setSiblingIndex(((_arithmeticOperatorHotSpot21.is("PLUS") ? (((childNodes.size()) + 1))) : (_arithmeticOperatorHotSpot21.is("MINUS") ? (((childNodes.size()) - 1))) : (_arithmeticOperatorHotSpot21.is("MUL") ? (((childNodes.size()) * 1))) : (_arithmeticOperatorHotSpot21.is("DIV") ? (((childNodes.size()) / 1)))));
        return this;
    }
    ...
    public org.jsoup.nodes.Element insertChildren(int index, java.util.Collection<? extends org.jsoup.nodes.Node> children) {
        ...
        if (index < 0)
            index += ((_arithmeticOperatorHotSpot22.is("PLUS") ? (currentSize + 1)) : (_arithmeticOperatorHotSpot22.is("MINUS") ? (currentSize - 1)) : (_arithmeticOperatorHotSpot22.is("MUL") ? (currentSize * 1)) : (_arithmeticOperatorHotSpot22.is("DIV") ? (currentSize / 1)));
    ...
    public java.lang.String cssSelector() {
        if ((id().length()) > 0)
            return ((_arithmeticOperatorHotSpot18.is("PLUS") ? ("#" + (id()))) : (_arithmeticOperatorHotSpot18.is("MINUS") ? ("#" - (id()))) : (_arithmeticOperatorHotSpot18.is("MUL") ? ("#" * (id()))) : (_arithmeticOperatorHotSpot18.is("DIV") ? ("#" / (id()))));
        ...
        if ((parent().select(selector.toString()).size()) > 1)
            selector.append(java.lang.String.format(":nth-child(%d)", ((_arithmeticOperatorHotSpot19.is("PLUS") ? (((elementSiblingIndex()) + 1))) : (_arithmeticOperatorHotSpot19.is("MINUS") ? (((elementSiblingIndex()) - 1))) : (_arithmeticOperatorHotSpot19.is("MUL") ? (((elementSiblingIndex()) * 1))) : (_arithmeticOperatorHotSpot19.is("DIV") ? (((elementSiblingIndex()) / 1))))));
        
        return ((_arithmeticOperatorHotSpot20.is("PLUS") ? ((parent().cssSelector()) + (selector.toString()))) : (_arithmeticOperatorHotSpot20.is("MINUS") ? ((parent().cssSelector()) - (selector.toString()))) : (_arithmeticOperatorHotSpot20.is("MUL") ? ((parent().cssSelector()) * (selector.toString()))) : (_arithmeticOperatorHotSpot20.is("DIV") ? ((parent().cssSelector()) / (selector.toString()))));
    }
    ...
    public org.jsoup.select.Elements siblingElements() {
        ...
        org.jsoup.select.Elements siblings = new org.jsoup.select.Elements(((_arithmeticOperatorHotSpot30.is("PLUS") ? (((elements.size()) + 1))) : (_arithmeticOperatorHotSpot30.is("MINUS") ? (((elements.size()) - 1))) : (_arithmeticOperatorHotSpot30.is("MUL") ? (((elements.size()) * 1))) : (_arithmeticOperatorHotSpot30.is("DIV") ? (((elements.size()) / 1)))));
    ...
    public org.jsoup.nodes.Element nextElementSibling() {
        ...
        if ((siblings.size()) > ((_arithmeticOperatorHotSpot24.is("PLUS") ? ((index + 1))) : (_arithmeticOperatorHotSpot24.is("MINUS") ? ((index - 1))) : (_arithmeticOperatorHotSpot24.is("MUL") ? ((index * 1))) : (_arithmeticOperatorHotSpot24.is("DIV") ? ((index / 1)))))
            return siblings.get(((_arithmeticOperatorHotSpot25.is("PLUS") ? ((index + 1))) : (_arithmeticOperatorHotSpot25.is("MINUS") ? ((index - 1))) : (_arithmeticOperatorHotSpot25.is("MUL") ? ((index * 1))) : (_arithmeticOperatorHotSpot25.is("DIV") ? ((index / 1)))));
        else
            return null;
    ...
    public org.jsoup.nodes.Element previousElementSibling() {
        ...
        org.jsoup.helper.Validate.notNull(index);
        if (index > 0)
            return siblings.get(((_arithmeticOperatorHotSpot26.is("PLUS") ? ((index + 1))) : (_arithmeticOperatorHotSpot26.is("MINUS") ? ((index - 1))) : (_arithmeticOperatorHotSpot26.is("MUL") ? ((index * 1))) : (_arithmeticOperatorHotSpot26.is("DIV") ? ((index / 1)))));
        else
            return null;
    ...
    public org.jsoup.nodes.Element lastElementSibling() {
        java.util.List<org.jsoup.nodes.Element> siblings = parent().children();
        return (siblings.size()) > 1 ? siblings.get(((_arithmeticOperatorHotSpot23.is("PLUS") ? (((siblings.size()) + 1))) : (_arithmeticOperatorHotSpot23.is("MINUS") ? (((siblings.size()) - 1))) : (_arithmeticOperatorHotSpot23.is("MUL") ? (((siblings.size()) * 1))) : (_arithmeticOperatorHotSpot23.is("DIV") ? (((siblings.size()) / 1))))) : null;
    }
    ...
    public org.jsoup.select.Elements getElementsByAttributeValueMatching(java.lang.String key, java.lang.String regex) {
        ...
        try {
            ...
            throw new java.lang.IllegalArgumentException(((_arithmeticOperatorHotSpot27.is("PLUS") ? (("Pattern syntax error: " + regex))) : (_arithmeticOperatorHotSpot27.is("MINUS") ? (("Pattern syntax error: " - regex))) : (_arithmeticOperatorHotSpot27.is("MUL") ? (("Pattern syntax error: " * regex))) : (_arithmeticOperatorHotSpot27.is("DIV") ? (("Pattern syntax error: " / regex)))) , e);
        }
    ...
    public org.jsoup.select.Elements getElementsMatchingText(java.lang.String regex) {
        ...
        try {
            ...
            throw new java.lang.IllegalArgumentException(((_arithmeticOperatorHotSpot29.is("PLUS") ? (("Pattern syntax error: " + regex))) : (_arithmeticOperatorHotSpot29.is("MINUS") ? (("Pattern syntax error: " - regex))) : (_arithmeticOperatorHotSpot29.is("MUL") ? (("Pattern syntax error: " * regex))) : (_arithmeticOperatorHotSpot29.is("DIV") ? (("Pattern syntax error: " / regex)))) , e);
        }
    ...
    public org.jsoup.select.Elements getElementsMatchingOwnText(java.lang.String regex) {
        ...
        try {
            ...
            throw new java.lang.IllegalArgumentException(((_arithmeticOperatorHotSpot28.is("PLUS") ? (("Pattern syntax error: " + regex))) : (_arithmeticOperatorHotSpot28.is("MINUS") ? (("Pattern syntax error: " - regex))) : (_arithmeticOperatorHotSpot28.is("MUL") ? (("Pattern syntax error: " * regex))) : (_arithmeticOperatorHotSpot28.is("DIV") ? (("Pattern syntax error: " / regex)))) , e);
        }
    ...
    public int hashCode() {
        ...
        result = ((_arithmeticOperatorHotSpot17.is("PLUS") ? ((31 + result))) : (_arithmeticOperatorHotSpot17.is("MINUS") ? ((31 - result))) : (_arithmeticOperatorHotSpot17.is("MUL") ? ((31 * result))) : (_arithmeticOperatorHotSpot17.is("DIV") ? ((31 / result)))) + ((tag) != null ? tag.hashCode() : 0);
        return result;
    }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot17 = metamutator.Selector.of(17,new String[]{"MUL","PLUS","MINUS","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot17");

    private static final metamutator.Selector _arithmeticOperatorHotSpot18 = metamutator.Selector.of(18,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot18");

    private static final metamutator.Selector _arithmeticOperatorHotSpot19 = metamutator.Selector.of(19,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot19");

    private static final metamutator.Selector _arithmeticOperatorHotSpot20 = metamutator.Selector.of(20,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot20");

    private static final metamutator.Selector _arithmeticOperatorHotSpot21 = metamutator.Selector.of(21,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot21");

    private static final metamutator.Selector _arithmeticOperatorHotSpot22 = metamutator.Selector.of(22,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot22");

    private static final metamutator.Selector _arithmeticOperatorHotSpot23 = metamutator.Selector.of(23,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot23");

    private static final metamutator.Selector _arithmeticOperatorHotSpot24 = metamutator.Selector.of(24,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot24");

    private static final metamutator.Selector _arithmeticOperatorHotSpot25 = metamutator.Selector.of(25,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot25");

    private static final metamutator.Selector _arithmeticOperatorHotSpot26 = metamutator.Selector.of(26,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot26");

    private static final metamutator.Selector _arithmeticOperatorHotSpot27 = metamutator.Selector.of(27,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot27");

    private static final metamutator.Selector _arithmeticOperatorHotSpot28 = metamutator.Selector.of(28,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot28");

    private static final metamutator.Selector _arithmeticOperatorHotSpot29 = metamutator.Selector.of(29,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot29");

    private static final metamutator.Selector _arithmeticOperatorHotSpot30 = metamutator.Selector.of(30,new String[]{"MINUS","PLUS","MUL","DIV"}).in(org.jsoup.nodes.Element.class).id("_arithmeticOperatorHotSpot30");
}
