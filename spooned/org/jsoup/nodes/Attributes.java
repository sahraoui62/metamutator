...
public class Attributes implements java.lang.Cloneable , java.lang.Iterable<org.jsoup.nodes.Attribute> {
    ...
    public java.lang.String get(java.lang.String key) {
        ...
        org.jsoup.nodes.Attribute attr = attributes.get(key.toLowerCase());
    ...
    void html(java.lang.StringBuilder accum, org.jsoup.nodes.Document.OutputSettings out) {
        if ((attributes) == null)
            return ;
    ...
    private static java.lang.String dataKey(java.lang.String key) {
        return ((_arithmeticOperatorHotSpot15.is("PLUS") ? ((org.jsoup.nodes.Attributes.dataPrefix) + key)) : (_arithmeticOperatorHotSpot15.is("MINUS") ? ((org.jsoup.nodes.Attributes.dataPrefix) - key)) : (_arithmeticOperatorHotSpot15.is("MUL") ? ((org.jsoup.nodes.Attributes.dataPrefix) * key)) : (_arithmeticOperatorHotSpot15.is("DIV") ? ((org.jsoup.nodes.Attributes.dataPrefix) / key)));
    }

    private static final metamutator.Selector _arithmeticOperatorHotSpot15 = metamutator.Selector.of(15,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.nodes.Attributes.class).id("_arithmeticOperatorHotSpot15");
}
