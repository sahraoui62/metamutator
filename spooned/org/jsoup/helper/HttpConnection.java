...
public class HttpConnection implements org.jsoup.Connection {
    ...
    public org.jsoup.Connection url(java.lang.String url) {
        ...
        try {
            ...
            throw new java.lang.IllegalArgumentException(("Malformed URL: " + url) , e);
        }
        return this;
    }
    ...
    public org.jsoup.Connection data(java.lang.String... keyvals) {
        ...
        for (int i = (_constantOperatorMetaMutator9.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator9.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator9.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0)))) ; i < (keyvals.length) ; i += 2) {
    ...
    public static class Response extends org.jsoup.helper.HttpConnection.Base<org.jsoup.Connection.Response> implements org.jsoup.Connection.Response {
        ...
        private int numRedirects = (_constantOperatorMetaMutator5.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator5.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator5.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0))));
        ...
        static org.jsoup.helper.HttpConnection.Response execute(org.jsoup.Connection.Request req, org.jsoup.helper.HttpConnection.Response previousResponse) throws java.io.IOException {
            ...
            try {
                ...
                int status = (_constantOperatorMetaMutator7.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator7.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator7.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(conn.getResponseCode()))));
        ...
        private static java.util.LinkedHashMap<java.lang.String, java.util.List<java.lang.String>> createHeaderMap(java.net.HttpURLConnection conn) {
            ...
            int i = (_constantOperatorMetaMutator6.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator6.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator6.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0))));
            while (true) {
            ...
            for (java.util.Map.Entry<java.lang.String, java.util.List<java.lang.String>> entry : resHeaders.entrySet()) {
                ...
                if (name.equalsIgnoreCase("Set-Cookie")) {
                    ...
                    if ((values.size()) == 1)
                        ...
                        for (int i = (_constantOperatorMetaMutator8.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator8.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator8.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0)))) ; i < (values.size()) ; i++) {
        ...
        private static java.lang.String setOutputContentType(final org.jsoup.Connection.Request req) {
            ...
            if (needsMulti) {
                ...
                req.header(org.jsoup.helper.HttpConnection.CONTENT_TYPE, (((org.jsoup.helper.HttpConnection.MULTIPART_FORM_DATA) + "; boundary=") + bound));
            } else {
                req.header(org.jsoup.helper.HttpConnection.CONTENT_TYPE, (((org.jsoup.helper.HttpConnection.FORM_URL_ENCODED) + "; charset=") + (req.postDataCharset())));
            }
            return bound;
        }
    ...
    private static final metamutator.Selector _constantOperatorMetaMutator5 = metamutator.Selector.of(5,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator5");

    private static final metamutator.Selector _constantOperatorMetaMutator6 = metamutator.Selector.of(6,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator6");

    private static final metamutator.Selector _constantOperatorMetaMutator7 = metamutator.Selector.of(7,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator7");

    private static final metamutator.Selector _constantOperatorMetaMutator8 = metamutator.Selector.of(8,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator8");

    private static final metamutator.Selector _constantOperatorMetaMutator9 = metamutator.Selector.of(9,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).in(org.jsoup.helper.HttpConnection.class).id("_constantOperatorMetaMutator9");
}
