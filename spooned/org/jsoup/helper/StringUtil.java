...
public final class StringUtil {
    ...
    public static java.net.URL resolve(java.net.URL base, java.lang.String relUrl) throws java.net.MalformedURLException {
        if (relUrl.startsWith("?"))
            relUrl = ((_arithmeticOperatorHotSpot12.is("PLUS") ? ((base.getPath()) + relUrl)) : (_arithmeticOperatorHotSpot12.is("MINUS") ? ((base.getPath()) - relUrl)) : (_arithmeticOperatorHotSpot12.is("MUL") ? ((base.getPath()) * relUrl)) : (_arithmeticOperatorHotSpot12.is("DIV") ? ((base.getPath()) / relUrl)));
        
        if (((relUrl.indexOf('.')) == 0) && ((base.getFile().indexOf('/')) != 0)) {
            base = new java.net.URL(base.getProtocol() , base.getHost() , base.getPort() , ((_arithmeticOperatorHotSpot13.is("PLUS") ? (("/" + (base.getFile())))) : (_arithmeticOperatorHotSpot13.is("MINUS") ? (("/" - (base.getFile())))) : (_arithmeticOperatorHotSpot13.is("MUL") ? (("/" * (base.getFile())))) : (_arithmeticOperatorHotSpot13.is("DIV") ? (("/" / (base.getFile()))))));
        } 
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot12 = metamutator.Selector.of(12,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.helper.StringUtil.class).id("_arithmeticOperatorHotSpot12");

    private static final metamutator.Selector _arithmeticOperatorHotSpot13 = metamutator.Selector.of(13,new String[]{"PLUS","MINUS","MUL","DIV"}).in(org.jsoup.helper.StringUtil.class).id("_arithmeticOperatorHotSpot13");
}
