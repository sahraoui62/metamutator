...
public abstract class Evaluator {
    ...
    public abstract static class CssNthEvaluator extends org.jsoup.select.Evaluator {
        ...
        public boolean matches(org.jsoup.nodes.Element root, org.jsoup.nodes.Element element) {
            ...
            final int pos = (_constantOperatorMetaMutator126.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator126.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator126.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(calculatePosition(root, element)))));
            if ((a) == 0)
                return pos == (b);
    ...
    public static class IsNthOfType extends org.jsoup.select.Evaluator.CssNthEvaluator {
        ...
        protected int calculatePosition(org.jsoup.nodes.Element root, org.jsoup.nodes.Element element) {
            int pos = (_constantOperatorMetaMutator131.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator131.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator131.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0))));
            org.jsoup.select.Elements family = element.parent().children();
            for (int i = (_constantOperatorMetaMutator130.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator130.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator130.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0)))) ; i < (family.size()) ; i++) {
    ...
    public static class IsNthLastOfType extends org.jsoup.select.Evaluator.CssNthEvaluator {
        ...
        @java.lang.Override
        protected int calculatePosition(org.jsoup.nodes.Element root, org.jsoup.nodes.Element element) {
            int pos = (_constantOperatorMetaMutator129.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator129.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator129.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0))));
            org.jsoup.select.Elements family = element.parent().children();
            for (int i = (_constantOperatorMetaMutator128.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator128.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator128.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(element.elementSiblingIndex())))) ; i < (family.size()) ; i++) {
                if (family.get(i).tag().equals(element.tag()))
                    pos++;
    ...
    public static final class IsOnlyOfType extends org.jsoup.select.Evaluator {
        ...
        public boolean matches(org.jsoup.nodes.Element root, org.jsoup.nodes.Element element) {
            ...
            int pos = (_constantOperatorMetaMutator133.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator133.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator133.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0))));
            org.jsoup.select.Elements family = p.children();
            for (int i = (_constantOperatorMetaMutator132.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator132.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator132.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0)))) ; i < (family.size()) ; i++) {
                if (family.get(i).tag().equals(element.tag()))
                    pos++;
    ...
    public static final class IsEmpty extends org.jsoup.select.Evaluator {
        ...
        public boolean matches(org.jsoup.nodes.Element root, org.jsoup.nodes.Element element) {
            ...
            for (int i = (_constantOperatorMetaMutator127.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO)?( 0 ):(_constantOperatorMetaMutator127.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX)?( 2147483646 ):(_constantOperatorMetaMutator127.is(metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN)?( -2147483647 ):(0)))) ; i < (family.size()) ; i++) {
    ...
    private static final metamutator.Selector _constantOperatorMetaMutator126 = metamutator.Selector.of(126,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator126");

    private static final metamutator.Selector _constantOperatorMetaMutator127 = metamutator.Selector.of(127,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator127");

    private static final metamutator.Selector _constantOperatorMetaMutator128 = metamutator.Selector.of(128,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator128");

    private static final metamutator.Selector _constantOperatorMetaMutator129 = metamutator.Selector.of(129,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator129");

    private static final metamutator.Selector _constantOperatorMetaMutator130 = metamutator.Selector.of(130,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator130");

    private static final metamutator.Selector _constantOperatorMetaMutator131 = metamutator.Selector.of(131,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator131");

    private static final metamutator.Selector _constantOperatorMetaMutator132 = metamutator.Selector.of(132,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator132");

    private static final metamutator.Selector _constantOperatorMetaMutator133 = metamutator.Selector.of(133,new metamutator.ConstantReplacementMetaMutator.CONSTANT_REP[]{metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.ZERO,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.INT_MAX,metamutator.ConstantReplacementMetaMutator.CONSTANT_REP.MIN_MIN}).id("_constantOperatorMetaMutator133");
}
