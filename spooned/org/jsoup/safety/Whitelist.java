...
public class Whitelist {
    ...
    abstract static class TypedValue {
        ...
        public int hashCode() {
            final int prime = 31;
            int result = 1;
            result = ((_arithmeticOperatorHotSpot111.is("PLUS") ? ((prime + result))) : (_arithmeticOperatorHotSpot111.is("MINUS") ? ((prime - result))) : (_arithmeticOperatorHotSpot111.is("MUL") ? ((prime * result))) : (_arithmeticOperatorHotSpot111.is("DIV") ? ((prime / result)))) + ((value) == null ? 0 : value.hashCode());
            return result;
        }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot111 = metamutator.Selector.of(111,new String[]{"MUL","PLUS","MINUS","DIV"}).id("_arithmeticOperatorHotSpot111");
}
