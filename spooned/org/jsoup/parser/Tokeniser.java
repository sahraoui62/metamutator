...
final class Tokeniser {
    ...
    char[] consumeCharacterReference(java.lang.Character additionalAllowedCharacter, boolean inAttribute) {
        ...
        if (reader.matchConsume("#")) {
            ...
            int charval = (_constantOperatorMetaMutator13.is("ZERO")?( 0 ):(_constantOperatorMetaMutator13.is("INT_MAX")?( 2147483646 ):(_constantOperatorMetaMutator13.is("MIN_MIN")?( -2147483647 ):(-1))));
            try {
    ...
    private static final metamutator.Selector _constantOperatorMetaMutator13 = metamutator.Selector.of(13,new String[]{"ZERO","INT_MAX","MIN_MIN"}).in(org.jsoup.parser.Tokeniser.class).id("_constantOperatorMetaMutator13");
}
