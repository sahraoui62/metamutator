...
abstract class Token {
    ...
    static final class StartTag extends org.jsoup.parser.Token.Tag {
        ...
        public java.lang.String toString() {
            if (((attributes) != null) && ((attributes.size()) > 0))
                return ((((_arithmeticOperatorHotSpot100.is("PLUS") ? (("<" + (name())))) : (_arithmeticOperatorHotSpot100.is("MINUS") ? (("<" - (name())))) : (_arithmeticOperatorHotSpot100.is("MUL") ? (("<" * (name())))) : (_arithmeticOperatorHotSpot100.is("DIV") ? (("<" / (name()))))) + " ") + (attributes.toString())) + ">";
            else
                return ((_arithmeticOperatorHotSpot101.is("PLUS") ? (("<" + (name())))) : (_arithmeticOperatorHotSpot101.is("MINUS") ? (("<" - (name())))) : (_arithmeticOperatorHotSpot101.is("MUL") ? (("<" * (name())))) : (_arithmeticOperatorHotSpot101.is("DIV") ? (("<" / (name()))))) + ">";
    ...
    static final class EndTag extends org.jsoup.parser.Token.Tag {
        ...
        @java.lang.Override
        public java.lang.String toString() {
            return ((_arithmeticOperatorHotSpot99.is("PLUS") ? (("</" + (name())))) : (_arithmeticOperatorHotSpot99.is("MINUS") ? (("</" - (name())))) : (_arithmeticOperatorHotSpot99.is("MUL") ? (("</" * (name())))) : (_arithmeticOperatorHotSpot99.is("DIV") ? (("</" / (name()))))) + ">";
        }
    }
    ...
    static final class Comment extends org.jsoup.parser.Token {
        ...
        @java.lang.Override
        public java.lang.String toString() {
            return ((_arithmeticOperatorHotSpot98.is("PLUS") ? (("<!--" + (getData())))) : (_arithmeticOperatorHotSpot98.is("MINUS") ? (("<!--" - (getData())))) : (_arithmeticOperatorHotSpot98.is("MUL") ? (("<!--" * (getData())))) : (_arithmeticOperatorHotSpot98.is("DIV") ? (("<!--" / (getData()))))) + "-->";
        }
    }
...
Doctype, StartTag, EndTag, Comment, Character, EOF;    }
    ...
    private static final metamutator.Selector _arithmeticOperatorHotSpot98 = metamutator.Selector.of(98,new String[]{"PLUS","MINUS","MUL","DIV"}).id("_arithmeticOperatorHotSpot98");

    private static final metamutator.Selector _arithmeticOperatorHotSpot99 = metamutator.Selector.of(99,new String[]{"PLUS","MINUS","MUL","DIV"}).id("_arithmeticOperatorHotSpot99");

    private static final metamutator.Selector _arithmeticOperatorHotSpot100 = metamutator.Selector.of(100,new String[]{"PLUS","MINUS","MUL","DIV"}).id("_arithmeticOperatorHotSpot100");

    private static final metamutator.Selector _arithmeticOperatorHotSpot101 = metamutator.Selector.of(101,new String[]{"PLUS","MINUS","MUL","DIV"}).id("_arithmeticOperatorHotSpot101");
}
