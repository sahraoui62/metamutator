...
public class ReturnReplacementOperatorMetaMutatorTest {
    ...
    public void testBinaryOperatorMetaMutator() throws Exception {
        ...
        l.addInputResource("src/test/java/returnReplacement");
        ...
        // test with the first
        Selector sel=Selector.getSelectorByName(ReturnReplacementOperatorMetaMutator.PREFIX + "1");
        ...
        // INT_MIN
        sel.choose(1);
        assertEquals(Integer.MIN_VALUE + 1, invokeExactMethod(o, "op", new Object[] {0, 0}));
        
        // INT_MAX
        sel.choose(2);
        assertEquals(Integer.MAX_VALUE - 1, invokeExactMethod(o, "op", new Object[] {0, 0}));
        
        // ZERO
        sel.choose(3);
        assertEquals(0, invokeExactMethod(o, "op", new Object[] {20, 5}));
        
        // test with the second
        sel=Selector.getSelectorByName(ReturnReplacementOperatorMetaMutator.PREFIX + "2");
        
        // INIT
        sel.choose(0);
        assertEquals("Hello World", invokeExactMethod(o, "op2", new Object[] {"Hello World"}));
        
        // NULL
        sel.choose(1);
        assertEquals(null, invokeExactMethod(o, "op2", new Object[] {"Hello World"}));
