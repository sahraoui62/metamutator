...
public class ConstantReplacementMetaMutatorTest {
	...
	public void testConstantReplacementMetaMutator() throws Exception{
     ...
     // test with the first
        ...
        sel.choose(0);//NULL
        assertEquals(0, invokeExactMethod(o, "constant", new Object[] {}));
        
        sel.choose(1);
        assertEquals(Integer.MAX_VALUE-1, invokeExactMethod(o, "constant", new Object[] {}));
        
        sel.choose(2);
        assertEquals(Integer.MIN_VALUE+1, invokeExactMethod(o, "constant", new Object[] {}));
	}
}
